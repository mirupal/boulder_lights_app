...
class _MainPage extends State<MainPage> {
      ...
      body: Container(
        child: ListView(
          children: <Widget>[
              ...
              title: RaisedButton(
                ...
                onPressed: () async {
                  ...
                  if (selectedDevice != null) {
                    ...
                    _startShowBoard(context, selectedDevice);
                  } else {
            ...
            // ListTile(
            //     title: RaisedButton(
            //   child: const Text("Ed Board"),
            //   onPressed: () =>
            //       print('dummy'), //_startShowBoard(context, selectedDevice),
            // )),
          ],
        ),
      ),
  ...
  void _startShowBoard(BuildContext context, BluetoothDevice server) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) {
